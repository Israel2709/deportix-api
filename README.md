...
**BFF Formula 1:** `/formula-1/seasons` · `/formula-1/competitions` · `/formula-1/circuits` · `/formula-1/drivers` · `/formula-1/teams` · `/formula-1/races` · `/formula-1/rankings/{drivers,teams,races,startinggrid,fastestlaps}` · `/formula-1/pitstops` · `/formula-1/timezone` — full api-sports envelope + CRUD. Maps to F1 Firestore collections; not served by generic `/v1` league routes. See [docs/formula-1-api-reference.md](./docs/formula-1-api-reference.md).
